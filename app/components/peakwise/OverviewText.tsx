    ...
    <div className="bg-white text-black flex flex-col gap-14 px-4 md:px-12 lg:px-24 py-8 md:py-16">
      <div>
        ...
        <p className="leading-7">
          ...
          service-based business; they are building a movement around
          transparency, accessibility, and financial literacy. This project
          focused on creating a strong digital presence to communicate their
          mission, showcase their offerings, and connect effectively with their
          target audience.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="leading-7">
          ...
          saw an opportunity to bring all financial needs into one
          platform—helping users make smarter decisions with ease.
        </p>
      </div>
      ...
      <div>
        ...
        <div className=" mt-8 leading-7">
          ...
          <p>
            Enable seamless transfers, bill payments, and lifestyle
            transactions.
          </p>
          <p>Build trust through security, transparency, and education.</p>
          <p>
            To communicate this mission, they needed a website that told a
            compelling story, connected with users emotionally and practically,
            and reflected their innovative personality.
          </p>
        </div>
      </div>
